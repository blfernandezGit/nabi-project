...
import {ColumnContainer, TitleContainer, LogoImg, HideTableCell} from '../../Layout/Elements';
          ...
          <MaterialTable>
            ...
            <MaterialTableBody>
              { projectTicketsData &&
                                projectTicketsData
                                    .filter( (ticket) => {
                                      return ['title', 'description', 'ticket_no'].some((key) => ticket?.attributes[key].toString().toLowerCase().includes(debouncedFilter.toLowerCase()));
                                    })
                                    .map( (ticket) => {
                                      return <Ticket
                                        key = { ticket.id }
